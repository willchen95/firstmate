...
Firstmate-dispatched workers follow the generated contract in [`bin/fm-brief.sh`](bin/fm-brief.sh); finding decisions follow [`ask-user-authority`](.agents/skills/ask-user-authority/SKILL.md).
